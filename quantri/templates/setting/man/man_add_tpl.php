            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <?php if (isset($config['setting']['coords']) && $config['setting']['coords'] == true) { ?>
                        ...
                        <div class="form-group col-md-4 col-sm-6">
                            ...
                            <input type="text" class="form-control text-sm" name="data[options][tuvan]" id="tuvan" placeholder="Mô tả Bạn cần tư vấn ?" value="<?= (!empty($flash->has('tuvan'))) ? $flash->get('tuvan') : @$options['tuvan'] ?>">
                        </div>
                    <?php } ?>
                </div>
                <?php if (isset($config['setting']['coords_iframe']) && $config['setting']['coords_iframe'] == true) { ?>
                    <div class="form-group">
                        ...
                        <textarea class="form-control text-sm" name="data[options][copyright]" id="copyright" rows="5" placeholder="Copyright"><?= $func->decodeHtmlChars($flash->get('copyright')) ?: $func->decodeHtmlChars(@$options['copyright']) ?></textarea>
                    </div>
                    <div class="form-group">
