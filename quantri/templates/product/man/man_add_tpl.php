            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="form-group col-sm-6">
                        ...
                        <input type="text" class="form-control text-sm" name="data[options][baohanh]" id="baohanh" placeholder="Bảo hành" value="<?= $options['baohanh'] ?>">
                    </div>
                    <div class="form-group col-sm-6">
                        <label for="kichthuoc">Kích thước:</label>
                        <input type="text" class="form-control text-sm" name="data[options][kichthuoc]" id="kichthuoc" placeholder="Kích thước" value="<?= $options['kichthuoc'] ?>">
                    </div>
                    <div class="form-group col-sm-6">
                        <label for="khoiluong">Khối lượng:</label>
                        <input type="text" class="form-control text-sm" name="data[options][khoiluong]" id="khoiluong" placeholder="Khối lượng" value="<?= $options['khoiluong'] ?>">
                    </div>
                    <div class="form-group col-sm-6">
                        <label for="xuatxu">Xuất xứ:</label>
                        <input type="text" class="form-control text-sm" name="data[options][xuatxu]" id="xuatxu" placeholder="Xuất xứ" value="<?= $options['xuatxu'] ?>">
                    </div>
                    <div class="form-group col-sm-6">
                        <label for="nhasanxuat">Nhà sản xuất:</label>
                        <input type="text" class="form-control text-sm" name="data[options][nhasanxuat]" id="nhasanxuat" placeholder="Nhà sản xuất" value="<?= $options['nhasanxuat'] ?>">
                    </div>
                    <div class="form-group col-sm-6">
                        <label for="vanchuyen">Vận chuyển:</label>
                        <input type="text" class="form-control text-sm" name="data[options][vanchuyen]" id="vanchuyen" placeholder="Vận chuyển" value="<?= $options['vanchuyen'] ?>">
                    </div>
